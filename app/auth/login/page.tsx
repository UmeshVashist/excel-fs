...
export default function LoginPage() {
  ...
  useEffect(() => {
    ...
    if (
      ...
      // Use window.history.replaceState to clean up URL without triggering a Next.js navigation
      // This prevents the middleware from re-evaluating and potentially creating a loop
  ...
  return (
    <div className="w-full h-full flex items-center justify-center p-6">
      ...
      >
        <Card className="rainbow-animated-border border border-slate-700/50 bg-slate-950/30 backdrop-blur-xl shadow-2xl shadow-slate-900/50 hover:shadow-slate-900/70 transition-all duration-500 hover:border-slate-600/50 group">
          <motion.div
                ...
                >
                  ...
                  <div className="relative">
                    ...
                    <button
                      ...
                      className="absolute hover:cursor-pointer right-3 top-1/2 -translate-y-1/2 text-slate-400 hover:text-cyan-400 transition-colors duration-200"
                    >
