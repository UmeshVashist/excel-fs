            ...
            <div className="space-y-6">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Link href="/auth/sign-up">
                  <Button size="lg" className="w-full sm:w-auto bg-purple-500/20 text-purple-100 border border-purple-400/50 hover:bg-purple-500/30 hover:border-purple-400 backdrop-blur-sm">
                    Sign Up
                  </Button>
                </Link>
              </div>
