              ...
              <div className="flex items-center justify-between gap-4">
                <div className="flex-1 min-w-0">
                  <CardTitle className="text-white flex items-center gap-2 flex-wrap text-lg">
                    {shortcut.title}
                    {shortcut.is_favorite && <Star className="h-4 w-4 fill-amber-400 text-amber-400 shrink-0 drop-shadow-[0_0_8px_rgba(251,191,36,0.6)]" title="Favorite" />}
                    {!isOwner && (
                  ...
                  <div className="flex items-center gap-2">
                    <Button
                      ...
                      className={cn(
                        ...
                        shortcut.is_favorite && "bg-amber-500/20 border-amber-500/50 shadow-[0_0_12px_rgba(245,158,11,0.3)]"
                      )}
                      title={shortcut.is_favorite ? "Remove from favorites" : "Add to favorites"}
                    >
                      <Star className={cn("h-4 w-4 transition-all", shortcut.is_favorite ? "fill-amber-400 text-amber-400 drop-shadow-[0_0_6px_rgba(251,191,36,0.6)]" : "text-slate-400 hover:text-amber-300")} />
                    </Button>
